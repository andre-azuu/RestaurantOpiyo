...
<head>
    ...
    <link rel="shortcut icon" href="images/foodlogo1.png">
    <title>Orders </title>
    <style>
/* ===============
   Fonts [Web Fonts]
...
<body>
    ...
    <header>
            ...
            <section id="contact-form">
                <form name= "contactForm" id="contactForm" method = POST  action="process.php">
                    ...
                    <div>
                        ...
                        <select name="postalCode" id="postalCode" required class="form-select">
                        ...
                        <!-- messages -->
                    <label for="messages">Order</label>
        ...
        <footer>
            <p>Opiyo's restaurant &copy; 2023</p>
        </footer>
    </div>
</body>
